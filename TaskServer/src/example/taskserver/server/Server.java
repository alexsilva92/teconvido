...
import com.utilities.communication.socket.safesocket.SafeServerSocket;
import com.utilities.communication.socket.safesocket.SafeSocket;
...
public class Server extends AbstractServer{
    ...
    private static final Logger LOOGER = Logger.getLogger(Server.class);
    
    private static final String SERVER_LOGGER_PROPERTIES = 
            "logger/server.logger.properties";
    
    public Server(int port,AbstractTaskManager manager) throws IOException{
        super(port,manager);
        LOOGER.info("SERVIDOR | Servidor iniciado en el puerto: " 
                + port);
    }
    
    public Server(AbstractTaskManager manager) throws IOException{
